    ...
    <footer className="bg-[#0d4b3e] text-[#f8f8f5] mt-32">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2">
          <div className="mb-6 w-48 bg-white/95 rounded-2xl p-3 inline-block shadow-xl">
            <img
              src="/images/self-logo.png"
              alt="SELF Wellness"
          ...
          <p className="text-[#f8f8f5]/70 text-sm leading-relaxed max-w-xs mb-6">
            Thoughtfully made for you. Premium wellness essentials crafted for strength, energy, lifestyle & fulfillment.
          </p>
          <div className="flex gap-3">
            {["Instagram", "Facebook", "Pinterest", "YouTube"].map(social => (
              <a key={social} href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#ff7a00] flex items-center justify-center transition-colors text-sm">
                {social[0]}
              </a>
            ))}
          </div>
        ...
        <div>
          <h4 className="text-sm tracking-[0.2em] uppercase mb-5 text-[#ff7a00]">Shop</h4>
          <ul className="space-y-3 text-sm text-[#f8f8f5]/80">
            <li><Link to="/shop" className="hover:text-[#ff7a00]">All Products</Link></li>
            <li><Link to="/shop?cat=soap" className="hover:text-[#ff7a00]">Soaps</Link></li>
            <li><Link to="/shop?cat=scrub" className="hover:text-[#ff7a00]">Scrubs</Link></li>
        ...
        <div>
          <h4 className="text-sm tracking-[0.2em] uppercase mb-5 text-[#ff7a00]">Explore</h4>
          <ul className="space-y-3 text-sm text-[#f8f8f5]/80">
        ...
        <div>
          <h4 className="text-sm tracking-[0.2em] uppercase mb-5 text-[#ff7a00]">Support</h4>
          <ul className="space-y-3 text-sm text-[#f8f8f5]/80">
            ...
            <li><Link to="/privacy" className="hover:text-[#ff7a00]">Privacy</Link></li>
            <li><Link to="/terms" className="hover:text-[#ff7a00]">Terms</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-8 border-t border-[#f8f8f5]/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#f8f8f5]/60">
        <p>© 2026 SELF Wellness. All rights reserved.</p>
...
export const WhatsAppButton: React.FC = () => (
  <a
    href="https://wa.me/919999999999?text=Hello%20SELF%20Wellness!"
    target="_blank"
    rel="noopener"
