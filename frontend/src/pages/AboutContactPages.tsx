  ...
  return (
    <div className="pt-[140px]">
      <section className="py-32 px-6 lg:px-10 bg-gradient-to-b from-[#0d4b3e] to-[#0d4b3e]/90 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20"><img src="/images/hero-lifestyle.jpg" className="w-full h-full object-cover" alt="" /></div>
        <div className="relative max-w-5xl mx-auto text-center">
          <p className="text-[#ff7a00] text-sm tracking-[0.35em] uppercase mb-4">We'd Love to Hear</p>
          <h1 className="font-display text-5xl md:text-7xl">
            Get in <span className="font-script text-[#ff7a00] font-normal">Touch</span>
          </h1>
        </div>
      </section>

      <section className="max-w-6xl mx-auto px-6 lg:px-10 py-32 grid lg:grid-cols-2 gap-16">
        <motion.div {...fadeUp}>
          <h2 className="font-display text-4xl mb-6">Say hello.</h2>
          <p className="text-[#777777] leading-relaxed mb-10">
            Whether it's a question, a compliment, or a collaboration — our wellness advisors are here for you.
          </p>

          <div className="space-y-6">
            {[
              { Icon: EnvelopeIconC, l: "Email", v: "hello@selfwellness.co" },
              { Icon: PhoneIconC, l: "Phone", v: "+91 99999 99999" },
              { Icon: LocationIconC, l: "Studio", v: "Mumbai · Dubai · London" },
              { Icon: MessageIconC, l: "WhatsApp", v: "Chat 24/7" },
            ].map(c => (
              <div key={c.l} className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-[#0d4b3e]/10 hover:border-[#ff7a00]/30 hover:shadow-md transition-all duration-300">
                <div className="w-10 h-10 rounded-xl bg-[#0d4b3e]/6 flex items-center justify-center flex-shrink-0">
                  <c.Icon className="w-4 h-4 text-[#0d4b3e]" strokeWidth={1.5} />
                </div>
                <div>
                  <div className="text-xs text-[#777777] tracking-wider uppercase">{c.l}</div>
                  <div className="text-[#1c1c1c]">{c.v}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <motion.form
          ...
          className="bg-white rounded-3xl p-10 shadow-sm border border-[#0d4b3e]/10 space-y-5"
        >
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="text-xs tracking-wider uppercase text-[#777777] mb-2 block">First Name</label>
              <input required className="w-full border-b-2 border-[#0d4b3e]/20 focus:border-[#ff7a00] outline-none py-3 bg-transparent transition-colors" />
            </div>
            <div>
              <label className="text-xs tracking-wider uppercase text-[#777777] mb-2 block">Last Name</label>
              <input required className="w-full border-b-2 border-[#0d4b3e]/20 focus:border-[#ff7a00] outline-none py-3 bg-transparent transition-colors" />
            </div>
          </div>
          <div>
            <label className="text-xs tracking-wider uppercase text-[#777777] mb-2 block">Email</label>
            <input type="email" required className="w-full border-b-2 border-[#0d4b3e]/20 focus:border-[#ff7a00] outline-none py-3 bg-transparent transition-colors" />
          </div>
          <div>
            <label className="text-xs tracking-wider uppercase text-[#777777] mb-2 block">Subject</label>
            <select className="w-full border-b-2 border-[#0d4b3e]/20 focus:border-[#ff7a00] outline-none py-3 bg-transparent">
          ...
          <div>
            <label className="text-xs tracking-wider uppercase text-[#777777] mb-2 block">Message</label>
            <textarea required rows={4} className="w-full border-b-2 border-[#0d4b3e]/20 focus:border-[#ff7a00] outline-none py-3 bg-transparent resize-none" />
          </div>
          <button type="submit" className="w-full bg-[#ff7a00] hover:bg-[#ff9a33] text-white py-4 rounded-full tracking-wider uppercase text-sm font-medium transition-all">
